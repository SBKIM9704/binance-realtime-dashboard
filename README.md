...
수집기는 기동 시 설정 요약을 찍고, **백필이 진행되는 동안 티어별 진행 상황을 제자리에서 갱신**하며,
끝나면 **방금 수집한 가격을 아스키 스파크라인으로** 그린 준비 완료 카드를 출력합니다.
...
```
  ...
  ● backfill  1s  BTCUSDT   ██████████████░░░░░░  69%  60,000 candles · 27p left
              1s  ETHUSDT   ░░░░░░░░░░░░░░░░░░░░   0%  waiting
              1m  BTCUSDT   ████████████████████ 100%  43,200 candles
              1m  ETHUSDT   █████████░░░░░░░░░░░  46%  20,000 candles · 24p left
              elapsed 21.4s · 51 page(s) to go
...
> 진행 블록은 TTY에서만 제자리 갱신됩니다. 파이프·CI·journald로 흘려보내면 같은 상태가 10%
> 단위 로그 한 줄씩으로 나옵니다. 백필 진행은 수집기를 띄운 사람이 보는 것이라 **콘솔에만**
> 있습니다 — 대시보드는 시장과 수집 상태를 보는 자리고, 콜드 스타트 몇 분을 위해 매초
> SSE에 진행 행을 실어 보낼 이유가 없습니다. `/ops`의 이벤트 로그에 백필 시작·완료가 남습니다.
>
