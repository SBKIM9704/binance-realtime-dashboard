...
export const dict = {
  ko: {
    ...
    "footer.text": "Binance 실시간 마켓 데이터 · {time} 기준 · 1초마다 갱신",
  ...
  en: {
    ...
    "footer.text": "Binance live market data · as of {time} · refreshed every 1s",
    ...
    "table.title": "Candles",
    "table.subtitle": "Recent 1m candles",
    "table.time": "Time",
    "table.open": "Open",
    "table.high": "High",
    "table.low": "Low",
